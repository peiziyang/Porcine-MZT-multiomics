...
# ── CONFIG: set these to your local paths (or export env vars CG_DIR/GTF/OUT) ──
CG_DIR = os.environ.get("CG_DIR", r"REPLACE_WITH_PATH_TO_YOUR/cgmap_dir")
GTF    = os.environ.get("GTF",   r"REPLACE_WITH_PATH_TO_YOUR/Sus_scrofa.Sscrofa11.1.113.gtf.gz")
OUT    = os.environ.get("OUT",   r"REPLACE_WITH_PATH_TO_YOUR/processed/m4_mofa")
TSS_WINDOW = 2000
