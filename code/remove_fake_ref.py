#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""删除编造的 [23] 参考文献 + 重编号（24-33 → 23-32）+ 重建 32 条参考文献。"""
import re, shutil

md = r'E:/Workbuddy/2026-07-27-11-58-27/manuscript/mzt_bor_submission_v3.md'
with open(md, encoding='utf-8') as f:
    text = f.read()
shutil.copy(md, md + '.bak6.md')

# ===== Step 1: 重编号正文引用（24-33 → 23-32）=====
old_to_new = {i: i for i in range(1, 23)}          # 1-22 不变
for old in range(24, 34):                            # 24-33 → 23-32
...
29. Fan J, Liu C, Zhao Y, Xu Q, Yin Z, Liu Z, Mu Y. Single-cell RNA sequencing reveals differences in chromatin remodeling and energy metabolism among in vivo-developed, in vitro-fertilized, and parthenogenetically activated embryos from the oocyte to 8-cell stages in pigs. *Animals (Basel)* 2024; 14:465.

30. Herzog VA, Reichholf B, Neumann T, et al. Thiol-linked alkylation of RNA to assess expression dynamics. *Nat Methods* 2017; 14:1198\u20131204.

31. Flamary R, Courty N, Gramfort A, et al. POT: Python Optimal Transport. *J Mach Learn Res* 2021; 22:1\u20138.

32. Schiebinger G, Shu J, Tabaka M, et al. Optimal-transport analysis of single-cell gene expression identifies developmental trajectories in reprogramming. *Cell* 2019; 176:928\u2013943.
